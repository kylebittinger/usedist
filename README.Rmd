...
The `usedist` package allows us to select the distances only for rows B, A, F, and
D, *in that order*:
...
be equal to 1.  Checking the between-group distances is left as an exercise for
the reader.
